...
let inssLiquido = null;

if (salarioBruto <= 1556.94) {
  inssLiquido = salarioBruto * 0.08;
} else if (salarioBruto <= 2594.92) {
  inssLiquido = salarioBruto * 0.09;
} else if (salarioBruto <= 5189.82) {
  inssLiquido = salarioBruto * 0.11;
} else {
  inssLiquido = 570.88;
}

//FIM INSS
const baseSalarial = salarioBruto - inssLiquido;
...
if (baseSalarial <= 1903.98) {
  ...
  liquedo = baseSalarial * 0.075;
  taxa = 142.8;
} else if (baseSalarial <= 3750.05) {
  liquedo = baseSalarial * 0.15;
  taxa = 354.8;
} else if (baseSalarial <= 4664.68) {
  liquedo = baseSalarial * 0.225;
  taxa = 636.13;
} else {
  liquedo = baseSalarial * 0.225;
  taxa = 869.36;
...
//FIM IR
const netSalary = baseSalarial - (liquedo - taxa);
