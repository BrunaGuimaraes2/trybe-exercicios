...
const produto = 450;
const precoVenda = 1789;

const taixa = 20;
const itensVendido = 100;

if (produto < 0 || precoVenda < 0) {
  console.log("invalido input");
} else {
  const taxaCost = precoVenda * taixa;
  const lucroVenda = precoVenda - produto + taixa;
  console.log(itensVendido * lucroVenda);
}
